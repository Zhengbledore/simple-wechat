...
<script type="text/javascript" charset="utf-8">
    ...
    wx.ready(function(){
        wx.onMenuShareTimeline({
            title: '测试123', // 分享标题
            link: 'magical.echofault.com/WechatIMG27.jpeg', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
        ...
        wx.onMenuShareAppMessage({
            title: '测试321', // 分享标题
            desc: '啦啦啦啦啦', // 分享描述
            link: 'magical.echofault.com/images/WechatIMG27.jpeg', // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
            imgUrl: 'magical.echofault.com/images/WechatIMG27.jpeg', // 分享图标
